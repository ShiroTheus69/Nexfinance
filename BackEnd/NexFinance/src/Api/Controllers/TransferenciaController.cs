...
namespace NexFinance.src.Api.Controllers {
    ...
    public class TransferenciaController : ControllerBase {
        ...
        public TransferenciaController(ITransferenciaService service) => _service = service;
        ...
        [HttpPost]
        public async Task<IActionResult> Create([FromBody] CreateTransferenciaDto dto, CancellationToken ct) {
